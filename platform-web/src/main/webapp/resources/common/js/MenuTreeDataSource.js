var MenuTreeDataSource = function(options) {
	this._data 	= options.data;
	this._delay = options.delay;
}

MenuTreeDataSource.prototype.data = function(options, callback) {
	var self = this;
	var $data = null;
...
var menuTreeDataSource = new DataSourceTree({data: tree_data});
